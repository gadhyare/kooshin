...
if (!$helper->isCli()) {
    ...
    <div class="jumbotron">
        ...
        <p>&nbsp;</p>
        <p>
            <a class="btn btn-lg primary-color-dark" href="https://github.com/PHPOffice/PHPSpreadsheet" role="button"><i class="fa fa-github fa-lg" title="GitHub"></i>  Fork us on Github!</a>
            <a class="btn btn-lg primary-color-dark" href="https://phpspreadsheet.readthedocs.io" role="button"><i class="fa fa-book fa-lg" title="Docs"></i>  Read the Docs</a>
        </p>
    </div>
    <?php

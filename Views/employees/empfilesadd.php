  <?php
    /**
     * fileName: اضافة  ملفات خاصة بالموظف
     */
    ?>
                      ...
                      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <select name="emp_file_type" id="emp_file_type" class="form-control rounded-0 p-0 alert-info">
                                  ...
                                  <option value="Ducoment"> مستند </option>
                          ...
                          <button type="submit" name="addRec" class="btn success-color-dark text-white px-3 py-1"> اضافة الملف </button>

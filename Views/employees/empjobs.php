...
<a href="<?php echo ROOT_URL; ?>/employees/empjobsadd/<?php echo $id;?>" class="btn danger-color-dark text-white px-3 py-2 float-left">  اضافة مؤهل جديد </a>
<div class="clearfix"></div>

    <div class="container  m-auto bg-white text-right z-depth-0">
        <div class="card  z-depth-0 border">
            <div class="card-header py-2 px-1 text-center ">  المعلومات الوظيفية للموظف  </div>
            <div class="card-body p-0 border">
                <table class="table  striped-table border-0">
                    <thead>
                        ...
                        <th class="p-1 primary-color-dark text-white border">  العنوان الوظيفي </th>
                        <th class="p-1 primary-color-dark text-white border">  القسم الوظيفي </th>
                        ...
                        <th class="p-1 primary-color-dark text-white border"> المرتب  </th>
                        <th class="p-1 primary-color-dark text-white border"> تاريخ ترك العمل</th>
                        <th class="p-1 primary-color-dark text-white border"> ملاحظات حول الوظيفة  </th>
                    ...
                    <tbody>
                        <?php foreach ((array)$getData as $items) : ?>
                            ...
                            <td class="p-1 text-dark border"> <?php echo $i++;?>  </td>
                                <td class="p-1 text-dark border"> <?php echo $items['empjob_title'];?>  </td>
                                <td class="p-1 text-dark border"> <?php echo $op->getSelEmpSecByIdTxt($items['em_sec_id']);?>  </td>
                                <td class="p-1 text-dark border"> <?php echo $op->getSelEmpLevByIdTxt($items['em_lev_id']);?> </td>
                                <td class="p-1 text-dark border"> <?php echo $items['empjob_strdate'];?> </td>
                                <td class="p-1 text-dark border"> <?php echo $items['empjob_sellary'];?> </td>
                                <td class="p-1 text-dark border"> <?php echo $items['empjob_levdate'];?></td>
                                <td class="p-1 text-dark border"> <?php echo $items['empjob_note'];?></td>

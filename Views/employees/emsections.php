        ...
        <tbody>
          ...
          <?php foreach ((array)$viewmodel as $dep_temes_edite) : ?>
            ...
            <tr>
              ...
              <td class="p-1">
                <a href="<?php echo ROOT_URL; ?>/employees/emsectionsupdate/<?php echo $dep_temes_edite['em_sec_id']; ?>" class="btn primary-color-dark text-white rounded-0 py-1 px-2 "> <i class="fa fa-pencil p-0 p-0" aria-hidden="true"></i> </a>
                <a href="<?php echo ROOT_URL; ?>/employees/emsectionsdelete/<?php echo $dep_temes_edite['em_sec_id']; ?>" class="btn danger-color-dark text-white rounded-0 py-1 px-2 "> <i class="fa fa-trash-o" aria-hidden="true"></i> </a>
              </td>
            </tr>
          <?php endforeach; ?>
        </tbody>

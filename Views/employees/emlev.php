            ...
            <div class="card-body p-2">
                <div class="row">
                    <div class="form-group col-xs-12 col-md-6">
                        <label for="sem_lev_name"> القسم الوظيفي </label>
     ...
     <tbody>
       ...
       <?php foreach ((array)$viewmodel as $dep_temes_edite) : ?>
         ...
         <tr>
           ...
           <td class="p-1">
             <a href="<?php echo ROOT_URL; ?>/employees/emlevupdate/<?php echo $dep_temes_edite['em_lev_id']; ?>" class="btn bg-primary text-white rounded-0 py-1 px-2 "> <i class="fa fa-pencil p-0 p-0" aria-hidden="true"></i> </a>
             <a href="<?php echo ROOT_URL; ?>/employees/emlevdelete/<?php echo $dep_temes_edite['em_lev_id']; ?>" class="btn bg-danger text-white rounded-0 py-1 px-2 "> <i class="fa fa-trash-o" aria-hidden="true"></i> </a>
           </td>
         </tr>
       <?php endforeach; ?>
     </tbody>

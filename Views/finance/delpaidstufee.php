    ...
    <?php foreach ((array) $viewmodel as $delete_items) : ?>
        <div class="container p-2 mt-2 alert alert-danger text-center font-weight-bold col-xs-12 col-sm-10 col-md-6">
            <p class="lead p-2 mt-2  text-center">
                هل انت متأكد من حذف السجل [ <?php echo $delete_items['Invoice_id']; ?> ] ؟
            </p>
            ...
            <a href="<?php echo ROOT_URL; ?>/finance/paidstufee/<?php echo $delete_items['Invoice_id']; ?>" class="btn danger-color-dark   text-white  py-2 text-weight-bold">إلغاء</a>
        </div>

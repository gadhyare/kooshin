        ...
        <div class="card  ">
            ...
            <div class="card-body">
                ...
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <input type="submit" name="updateexpensetype" value="اضافة" class="btn primary-color-dark text-white px-3 py-2">
                    <a href="<?php echo ROOT_URL; ?>/finance/expensetype" class="btn danger-color-dark text-white p-2">إلغاء</a>
                </form>
            </div>
        </div>
    </div>

                    ...
                    <tr>
                        ...
                        <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                            ...
                            <?php $deleteFee = "حذف الرسم";?>
                             <a href="<?php echo ROOT_URL; ?>/finance/updatestuFee/<?php echo $item->Invoice_id; ?>" class="dropdown-item  text    " data-toggle="tooltip" title="تعديل الرسوم">  <?php echo  $editFee;?> </a>  
                             <a href="<?php echo ROOT_URL; ?>/finance/paidstufee/<?php echo $item->Invoice_id; ?>" class="dropdown-item  text    " data-toggle="tooltip" title="دفع الرسوم"> <?php echo  $paidFee ;?>  </a>  
                             <a href="<?php echo ROOT_URL; ?>/finance/deletestuFee/<?php echo $item->Invoice_id; ?>" class="dropdown-item  text    " data-toggle="tooltip" title="حذف الرسوم">  <?php echo  $deleteFee ;?> </a>  
                             </div>
                        </td>
                    </tr>
            <?php endforeach; ?>

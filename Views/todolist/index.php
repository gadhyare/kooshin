<div class="container">
<a href="<?php echo ROOT_URL ;?>/todolist/add" class="btn btn-primary mt-2 rounded-0 float-left"> <i class="fa fa-plus" aria-hidden="true"></i> اضافة مهمة جديدة </a>
    ...
    <div class="row">
            <?php foreach( $viewmodel as $doit){ ?>
                ...
                <?php $bg = ($doit['status'] == 1) ? 'bg-primary text-white' : (($doit['status'] == 2) ? 'bg-warning text-white' : 'bg-danger text-white' );?>

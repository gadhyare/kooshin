<div class="container col-xs-12 col-md-10 m-auto z-depth-2 text-right">
  <a href="<?php echo ROOT_URL; ?>/group/add" class="btn btn-primary mt-2 float-left rounded-0 mb-2 py-1 px-3">
      ...
      <?php foreach ($items as $dep_temes_edite) : ?>
        ...
        <tr>
          ...
          <td class="p-1" style="font-size:80%">
            <a href="<?php echo ROOT_URL; ?>/group/update/<?php echo $dep_temes_edite->grp_id; ?>" class="btn bg-primary text-white rounded-0 p-1 " style="font-size:80%"> <i class="fa fa-pencil p-0" aria-hidden="true"></i> </a>
            <a href="<?php echo ROOT_URL; ?>/group/delete/<?php echo $dep_temes_edite->grp_id; ?>" class="btn bg-danger text-white rounded-0 p-1 " style="font-size:80%"> <i class="fa fa-trash-o" aria-hidden="true"></i> </a>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>

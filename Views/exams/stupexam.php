             ...
             <form action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" method="post" role="form">
                 <div class="card-body" id="showExamResult">
                     ...
                     <table class="table table-bordered text-center">
                         <tr>
                             <td class="p-0 primary-color-dark text-white text-center" rowspan="2">الرقم الجامعي </td>
                             ...
                             <td class="p-0 primary-color-dark text-white text-center" rowspan="2"> الحضور </td>
                             <td class="p-0 primary-color-dark text-white text-center" rowspan="2"> المجموع</td>
                             <td class="p-0 primary-color-dark text-white text-center" rowspan="2"> التقدير</td>
                         </tr>
                         <tr>
                             <td class="p-0 primary-color-dark text-white text-center"> الأسئلة</td>
                             <td class="p-0 primary-color-dark text-white text-center"> البحث</td>
                             <td class="p-0 primary-color-dark text-white text-center"> الإختبار</td>
                             <td class="p-0 primary-color-dark text-white text-center"> الأسئلة</td>
                             <td class="p-0 primary-color-dark text-white text-center"> البحث</td>
                             <td class="p-0 primary-color-dark text-white text-center"> الإختبار </td>
                         </tr>

                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-5 border">
                            ...
                            <?php if(isset($_GET['ids'])):?>
                                ...
                                <button type="submit" name="sectionOne" id="sectionOne" class="btn success-color-dark p-2  text-white  float-right"> <i class="fa fa-paper-plane"></i> تعديل الأساسي </button>
                                <button type="submit" name="sectionTwo" id="sectionTwo" class="btn info-color-dark p-2  text-white float-right"> <i class="fa fa-paper-plane"></i> تعديل الدرجات </button>
                                <button type="submit" name="deleteRec" id="deleteRec" class="btn danger-color-dark p-2  text-white float-left"> <i class="fa fa-arrow-left"> </i> تراجع </button>
                            </form>
                            <?php SELECT_ID;?>
                            <?php endif;?>
                        </div>
                        <div class="col-xs-12 col-md-7">
                            <?php if (isset($_GET['type'])) : ?>
                                <?php if ($_GET['type'] == 'sectionOne') : ?>
                                    <?php require "updateexamSecone.php"; ?>
                                <?php elseif ($_GET['type'] == 'sectionTwo') : ?>
                                    <?php require "updateexamtwo.php"; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
                    </div>

                        ...
                        <div class="col-xs-12 col-md-2">
                            <div class="form-group pt-2">
                                ...
                                <button class="btn mdb-color darken-3 text-white    mt-2  rounded-0 mb-2 py-1 px-3" name="btnFullPro"> <i class="fa fa-check"></i> </button>
                                    <?php if($prog_id!=''):?><a href="<?php echo ROOT_URL; ?>/exams/searchresultprint/?s&<?php echo $print_url;?>" target="_blank" class="btn btn-primary mt-2  rounded-0 mb-2 py-1 px-3"> <i class="fa fa-print" aria-hidden="true"></i> </a><?php endif;?>
                            </div>
                        </div>
                    ...
                    <?php foreach ($items as $SearchResultShow => $val) : ?>
                        <tr>
                            ...
                            <td class="p-0 text-center">
                                ...
                                <a href="<?php echo ROOT_URL; ?>/exams/stdelexam/<?php echo $val->ex_id; ?>/<?php echo $_GET['action']; ?>" class="btn bg-danger text-white border-0 rounded-0 p-1"><i class="fa fa-trash-o" aria-hidden="true"></i> </a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>

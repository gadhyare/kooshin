          ...
          <tbody>
                ...
                <?php foreach ((array) $rt as $edu_eql_ifo) : ?>
                    ...
                    <td  class="p-1 text-center"  > 
                          ...
                          <a href="<?php echo ROOT_URL;?>/student/Studentacademicdel/<?php echo $edu_eql_ifo['Edu_id'];?>?stu_id=<?php echo $_GET['id'];?>" target="_blanck" class="px-2 bg-danger text-white ml-1" > <i class="fa fa-trash-o" aria-hidden="true"></i>  </a>
                    </td>
                  </tr>
                  <?php 
                  $i++;

...
<?php if(isset($_SESSION['hidden_fileds'] )) {  $di = $_SESSION['hidden_fileds'];} else { $di = '';}
...
<div class="container bg-primary  text-center rounded-0">
    ...
    <input type="file" name="fileToUpload" class="btn btn-primary   rounded-0" id="fileToUpload">

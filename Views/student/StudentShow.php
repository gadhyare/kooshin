...
<form action="<?php $_SERVER['PHP_SELF'];?>" method="post" >
 <div class="container text-left">
    <input type="submit" name="add_stu"  value="تعديل بيانات طالب" class="btn bg-danger   rounded-0 text-white    mb-3  py-2 px-3" name="add_student" > 
    <a href="<?php echo ROOT_URL;?>/student/info" class="btn bg-primary rounded-0 text-white mb-3 py-2 px-3"> الرجوع لبيانات الطلاب  </a> 
       ...
       <div id="accordion" role="tablist" aria-multiselectable="true">
            <div class="card mb-1  rounded-0">
                <div class="card-header accord-header bg-primary text-center    rounded-0" role="tab" id="headingOne">
                <h5 class="mb-0 ">
  ...
  <div class="card mb-1  rounded-0">
    <div class="card-header accord-header bg-primary rounded-0" role="tab" id="headingThree">
      <h5 class="mb-0">
  ...
  <div class="card mb-1  rounded-0">
    <div class="card-header accord-header bg-primary rounded-0" role="tab" id="headingTwo">
      <h5 class="mb-0">
  ...
  <div class="card mb-1  rounded-0">
    <div class="card-header accord-header bg-primary rounded-0" role="tab" id="headingFour">
      <h5 class="mb-0">
            ...
            <tr  > 
              ...
              <td >
                <div class="form-group input-group-sm p-1 m-0">
                    ...
                    <select onclick="dep_show()" name="department" id="" class="form-control input-sm p-1  rounded-0">
                        <?php get_department($stu_info_update['Department']); ?>
                    </select>  
                ...
                <div class="form-group input-group-sm p-1 m-0">
                    ...
                    <?php get_section($stu_info_update['Section']); ?>
                    </select>
              ...
              <div class="form-group input-group-sm p-1 m-0">
                    ...
                    <select onclick="grp_show()" onload="loadData()" name="group" id="" class="form-control input-sm p-1  rounded-0">
                        <?php get_group($stu_info_update['stuGroup']);?>
                    </select>
              ...
              <div class="form-group input-group-sm p-1 m-0">
                    ...
                    <select onclick="lev_show()" onload="loadData()" name="level" id="" class="form-control input-sm p-1  rounded-0"  >
                      <?php get_level($stu_info_update['StuLevel']);?>
                    </select>              

            ...
            <div class="card-body">
                <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="text-right">
                        <input type="submit" name="addStuRel" value="اضافة" class="btn primary-color-dark text-white float-right">
                        <a href="?men=men&p=students&a=update&id=<?php echo $_GET['id']; ?>" class="btn danger-color-dark text-white float-left">إلغاء</a>
                    </div>
                </form>
            </div>
        </div>

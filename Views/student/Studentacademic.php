                         ...
                         <td>
                             <div class="form-group input-group-sm p-1 m-0">
                                 ...
                                 <select name="Edu_quali" id="Edu_quali" class="form-control input-sm p-1  rounded-0">
                                     <option value="ثانوية علمية" selected> ثانوية علمية </option>
                             ...
                             <div class="form-group input-group-sm p-1 m-0">
                                 ...
                                 <input type="date" required="required" name="Edu_year" id="Edu_year" class="form-control input-sm p-1  rounded-0" placeholder="سنة التخرج">
                             </div>
                         </td>
                         <td>
                             <div class="form-group input-group-sm p-1 m-0">
                                 <label> الجهة التي تخرج منها </label>
                                 <input type="text" required="required" name="Edu_Issuer" id="Edu_Issuer" class="form-control input-sm p-1  rounded-0" placeholder=" الجهة التي تخرج منها    ">
                             </div>
                             <div class="form-group input-group-sm p-1 m-0">

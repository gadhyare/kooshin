    ...
    <div class="container col-xs-12 col-sm-12 col-md-10 m-auto ">
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="container text-left">
                <input type="submit" name="add_rel" value="اضافة" id="submit" class="btn danger-color-dark   rounded-0 text-white    mb-3  py-2 px-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group input-group-sm p-1 m-0">
                                            ...
                                            <input type="text" required="required" name="rel_name" value="<?php echo $op->setPosts("rel_name"); ?>" id="rel_name" class="form-control  p-1  rounded-0" placeholder="اسم القريب ">
                                        </div>
                                        <div class="form-group input-group-sm p-1 m-0">
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group input-group-sm p-1 m-0">
                                            <label> العنوان </label>
                                            <input type="text" required="required" name="rel_Address" value="<?php echo $op->setPosts("rel_Address"); ?>" id="rel_Address" class="form-control  p-1  rounded-0" placeholder=" الهواتف ">
                                        </div>

                                        <div class="form-group input-group-sm p-1 m-0">
                                            <label> البريد الألكتروني </label>
                                            <input type="text" required="required" name="rel_email" value="<?php echo $op->setPosts("rel_email"); ?>" id="rel_email" class="form-control  p-1  rounded-0" placeholder=" الهواتف ">
                                        </div>
                                        ...
                                        <div class="form-group input-group-sm p-1 m-0">
                                            <label> الهواتف </label>
                                            <input type="text" required="required" name="rel_phones" value="<?php echo $op->setPosts("rel_phones"); ?>" id="rel_phones" class="form-control  p-1  rounded-0" placeholder=" الهواتف ">
                                        </div>
                                    </td>

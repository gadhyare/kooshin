         ...
         <tbody>
           ...
           <?php foreach ($viewmodel as $itemss) : ?>
             ...
             <tr>
               ...
               <td class="p-1">
                 <a href="<?php echo ROOT_URL; ?>/level/update/<?php echo $itemss['lev_id']; ?>" class="btn bg-primary text-white rounded-0 py-1 px-2 px-3 "> <i class="fa fa-pencil p-0" aria-hidden="true"></i> </a>

                 <a href="<?php echo ROOT_URL; ?>/level/delete/<?php echo $itemss['lev_id']; ?>" class="btn bg-danger text-white rounded-0 py-1 px-2 px-3 "> <i class="fa fa-trash-o" aria-hidden="true"></i> </a>
               </td>
             </tr>
           <?php endforeach; ?>

...
<ul class="list-group border-0 col-xs-12 col-sm-12 col-md-8 m-auto">
    ...
    <a href="<?php echo ROOT_URL; ?>/settings/socialmediadd" class=" primary-color-dark  float-left rounded-0 mb-2 py-1 px-3 col-1 text-center"> <i class="fa fa-plus" aria-hidden="true"></i> </a>

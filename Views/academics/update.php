...
<div class="card  ">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" name="academics_edit" value="<?php echo $edit_items['academics'] ?>" class="form-control p-1  rounded-0" placeholder="أدخل هنا اسم المستوى " >
        </div>
        ...
        <a href="<?php echo ROOT_URL;?>/level" class="btn btn-danger text-light p-2">إلغاء</a>
        </form>
    </div>
</div>

...
<div class="container-fluid p-0">
  <div class="container-fluid py-2 blue-grey text-left " style="background-color: #344352 !important; ">
    <a href="<?php echo ROOT_URL; ?>/usrprofile/<?php echo $_SESSION['log_id']; ?>" class="nav-item text-white "> <?php echo $_SESSION['log_user']; ?></a>
    <a href="<?php echo ROOT_URL; ?>/usrprofile/logout" class="nav-item text-white   mr-5">  خروج </a>
  </div>
